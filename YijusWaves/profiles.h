...
#define MAXOUTPUTVARIABLES 10
#define ALLPROFILEVARIABLES "husbTqnkCzo"
...
FILE *FreeSurfaceProfFID, *HorizontalVelocityProfFID, *VerticalVelocityProfFID,
  ...
  *SediProfFID, *SediProfZeroFID, *SediProfOneFID;
...
void InterpData(sediT *sedi, gridT *grid, physT *phys, propT *prop, MPI_Comm, int numprocs, int myproc);
